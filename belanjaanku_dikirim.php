	...
	<div class="w3l_banner_nav_right">
		...
		<div class="privacy about">
			...
			<ul class="nav nav-tabs">
			    ...
			    <li role="presentation" class="active"><a href="#">Dikirim</a></li>
			    <li role="presentation"><a href="belanjaanku_selesai.php">Selesai</a></li>
			 </ul>
			 <div class="checkout-right">
			 	<h4>Pesanan lagi proses pengiriman</h4>
				<table class="timetable_sub">
					...
					<tbody>
						<?php
							...
							WHERE tbl_order.id_user={$dataUser['id_user']} AND tbl_order.status_order='Dikirim' GROUP BY tbl_order.id_order";       
							$records_per_page=10;
