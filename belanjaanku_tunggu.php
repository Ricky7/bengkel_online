	...
	<div class="w3l_banner_nav_right">
		...
		<div class="privacy about">
			...
			<ul class="nav nav-tabs">
			    ...
			    <li role="presentation" class="active"><a href="#">Menunggu</a></li>
			 ...
			 <div class="checkout-right">
			 	<h4>Menunggu konfirmasi petugas admin</h4>
				<table class="timetable_sub">
					...
					<tbody>
						<?php
							...
							WHERE tbl_order.id_user={$dataUser['id_user']} AND tbl_order.status_order='Tunggu' GROUP BY tbl_order.id_order";       
							$records_per_page=10;
