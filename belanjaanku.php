	...
	<div class="w3l_banner_nav_right">
		...
		<div class="privacy about">
			...
			<ul class="nav nav-tabs">
			    <li role="presentation" class="active"><a href="#">Belum Bayar</a></li>
			    <li role="presentation"><a href="belanjaanku_tunggu.php">Menunggu</a></li>
			    <li role="presentation"><a href="belanjaanku_proses.php">Proses</a></li>
			 ...
			 <div class="checkout-right">
			 	<h4>Pesanan yang belum dibayar</h4>
				<table class="timetable_sub">
					...
					<tbody>
						<?php
							...
							WHERE tbl_order.id_user={$dataUser['id_user']} AND tbl_order.status_order='Tidak bayar' GROUP BY tbl_order.id_order";       
							$records_per_page=10;
